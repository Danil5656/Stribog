...
//значения перестановок T для использования операции перестановки (P-преобразование)
...
//значения подстановок Pi для использования операции подстановки (S-преобразование)
const uint8_t sboxPi[256] = 
{
...
//значения матрицы А для умножения в поле Галуа (L-преобразование)
...
//значения итерационных констант С
